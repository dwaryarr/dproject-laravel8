        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h5>Pesanan andda sudah sukses dicheck out, untuk pembayaran silahkan transfer ke rekening <br>
                        <strong>Bank BCA : 123456789</strong> dengan nominal : <strong>Rp. {{ number_format($pesanan->kode+$pesanan->jumlah_harga) }}</strong>
                    </h5>
                </div>
            </div>
            <div class="card mt-2">
